...
params="--uring_io --store_file /opt/testDirectory --num_queries 100k --iterations 1 --queue_depth 128 --object_size_distribution normal"
...
cp /opt/pachash/build/figure-2.txt figure-2.txt
