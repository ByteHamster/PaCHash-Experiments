...
std::vector<std::string> randomKeys = generateRandomStringKeys(1000000);
RandomObjectProvider randomObjectProvider(EQUAL_DISTRIBUTION, 256);

void handleResult(void *arg, const leveldb::Slice &key, const leveldb::Slice &value) {
